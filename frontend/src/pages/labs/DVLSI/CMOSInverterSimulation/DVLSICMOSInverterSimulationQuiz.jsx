...
export default function DVLSICMOSInverterSimulationQuiz({
  experimentRun,
  questions,
  answers,
  submitted,
    ...
    <section className="quiz-shell">
      <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
        ...
        <div>
          ...
          <p className="sorting-sim-subtitle">
            Test your understanding of CMOS inverter switching behavior,
            transistor conduction, propagation delay, and logic inversion.
          </p>
        </div>
      </div>
      ...
      {!experimentRun ? (
        <div className="quiz-locked-box">
          ...
          <span>
            Please interact with the CMOS inverter simulation before attempting
            the quiz.
          </span>
        </div>
      ) : !submitted ? (
