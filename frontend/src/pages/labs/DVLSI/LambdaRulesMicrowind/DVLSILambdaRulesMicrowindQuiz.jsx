...
export default function DVLSILambdaRulesMicrowindQuiz({
  experimentRun,
  questions,
  answers,
  submitted,
    ...
    <section className="quiz-shell">
      <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
        ...
        <div>
          ...
          <p className="sorting-sim-subtitle">
            Test your understanding of lambda rules, layout scaling, and DRC concepts.
          </p>
        </div>
      </div>
      ...
      {!experimentRun ? (
        <div className="quiz-locked-box">
          <Lock size={18} />
          <span>
            Please interact with the lambda rules simulation before attempting the quiz.
          </span>
        </div>
      ) : !submitted ? (
