...
export default function DBMSJoinsQuiz({
  joinType,
  quizQuestions,
  quizAnswers,
  quizSubmitted,
        ...
        <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
          ...
          <div>
            ...
            <p className="sorting-sim-subtitle">
              Test your understanding after running the {joinType.toUpperCase()} JOIN experiment.
            </p>
          </div>
        </div>
    ...
    <section className="quiz-shell">
      <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
        ...
        <div>
          <h2 className="sorting-sim-title">Quiz</h2>
          <p className="sorting-sim-subtitle">
            Answer the questions below for {joinType.toUpperCase()} JOIN.
          </p>
        </div>
      </div>
