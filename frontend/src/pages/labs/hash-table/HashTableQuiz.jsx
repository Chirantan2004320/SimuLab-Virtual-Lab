...
export default function HashTableQuiz({
  quizQuestions,
  quizAnswers,
  quizSubmitted,
  quizScore,
        ...
        <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
          ...
          <div>
            ...
            <p className="sorting-sim-subtitle">
              Test your understanding after running the hash table simulation.
            </p>
          </div>
        </div>
    ...
    <section className="quiz-shell">
      <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
        ...
        <div>
          <h2 className="sorting-sim-title">Quiz</h2>
          <p className="sorting-sim-subtitle">
            Answer the questions below for Hash Table and Separate Chaining.
          </p>
        </div>
      </div>
