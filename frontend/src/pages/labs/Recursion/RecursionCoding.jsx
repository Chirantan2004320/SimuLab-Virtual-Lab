...
export default function RecursionCoding({
  ...
  return (
    <section className="card">
      ...
      <p>
        Practice {recursionType === "fibonacci" ? "fibonacci" : "factorial"} recursion
        in your preferred language. JavaScript execution works now. Other languages can be
        enabled later with Judge0.
      </p>
