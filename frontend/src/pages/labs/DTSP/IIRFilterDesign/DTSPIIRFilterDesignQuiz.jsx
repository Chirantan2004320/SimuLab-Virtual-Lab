...
export default function DTSPIIRFilterDesignQuiz({
  experimentRun,
  quizQuestions,
  quizAnswers,
  quizSubmitted,
    ...
    return (
      <section className="quiz-shell">
        <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
          ...
          <div>
            ...
            <p className="sorting-sim-subtitle">
              Test your understanding after designing the filter.
            </p>
          </div>
        </div>
        ...
        <div className="quiz-locked-box">
          <Lock size={18} />
          <span>Please design the filter at least once before attempting the quiz.</span>
        </div>
      </section>
    );
  }
    ...
    <section className="quiz-shell">
      <div className="sorting-sim-title-wrap" style={{ marginBottom: 18 }}>
        ...
        <div>
          <h2 className="sorting-sim-title">Quiz</h2>
          <p className="sorting-sim-subtitle">
            Answer the questions below for IIR Filter Design.
          </p>
        </div>
      </div>
