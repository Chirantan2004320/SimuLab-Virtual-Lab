...
export default function CPUSchedulingQuiz({
  algorithm,
  quizQuestions,
  quizAnswers,
  quizSubmitted,
  ...
  return (
    <section className="card">
      <h2>
        Quiz <span style={{ color: "#38bdf8" }}>({algorithm.toUpperCase()})</span>
      </h2>

      {!experimentRun ? (
        <p style={{ color: "#d1d5db" }}>
          You can attempt the quiz now, and later we can also lock it behind running the simulation.
        </p>
      ) : (
        <div>
