...
export default function SearchingCoding({
  codingProblem,
  selectedLanguage,
  setSelectedLanguage,
  code,
  ...
  return (
    <section className="card">
      ...
      <p>
        Practice {searchType === "binary" ? "binary search" : "linear search"} logic in your
        preferred language. JavaScript execution works now. Other languages can be enabled
        later with Judge0.
      </p>
